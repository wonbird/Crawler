...
import os
"""
This code base on Alir3z4/python-stop-words from GitHub
"""
__VERSION__ = (2015, 2, 23, 1)
CURRENT_DIR = os.path.dirname(os.path.realpath(__file__))
STOP_WORDS_DIR = os.path.join(CURRENT_DIR, 'stop_words')
STOP_WORDS_CACHE = {}
...
def get_stop_words(language, cache=True):
    ...
    language_filename = os.path.join(STOP_WORDS_DIR, 'stop_words_' + language + '.txt')
    try:
